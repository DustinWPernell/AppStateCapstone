...
urlpatterns = [
    ...
    path('select_commander/<deck_id>/', Commander_Picker.as_view(), name='select_commander'),
    path('select_deck_image/<deck_id>/', Image_Picker.as_view(), name='select_deck_image'),
