    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('oracle_id', models.CharField(max_length=200)),
                ('card_obj', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='legal_card',
                                               to='Collection.card')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('legal', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='face_legal',
        ...
        migrations.AddField(
            model_name='card',
            name='layout',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='card_layout',
                                    to='Collection.cardlayout'),
        ),
        migrations.AddField(
            model_name='card',
            name='set_obj',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='card_set',
                                    to='Collection.cardsets'),
        ),
    ]
